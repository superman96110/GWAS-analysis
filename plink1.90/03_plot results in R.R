##提取结果文件，便于CMplot绘图
##awk '{print $2,$1,$3,$9}' 546_plink_linear_pc1to3_sex.assoc.linear > 546_plink_linear_pc1to3_sex.assoc.txt

library(CMplot)

# 1. 读取数据
df <- read.delim("F:/caas/毕业课题/第四章_GWAS/horse/546_data/546_plink_linear_pc1to3_sex.assoc.txt",
